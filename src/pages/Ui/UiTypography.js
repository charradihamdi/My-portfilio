...
import { Card, Row, Col, CardBody, CardTitle, Media } from "reactstrap"
...
const UiTypography = props => {
  ...
  return (
    <React.Fragment>
      <MetaTags>
        <title>Typography | - Responsive Bootstrap 5 Admin Dashboard</title>
      </MetaTags>
          ...
          <Card>
            <CardBody>
              ...
              <p className="card-title-desc">
                ...
                system’s predefined className (or semantic mixins). For longer
