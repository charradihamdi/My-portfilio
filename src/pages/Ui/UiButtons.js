...
const UiButtons = props => {
  ...
  return (
    <React.Fragment>
      <MetaTags>
        <title>Buttons | - Responsive Bootstrap 5 Admin Dashboard</title>
      </MetaTags>
        ...
        <Col lg="6">
          <Card>
            <CardBody>
              ...
              <p className="card-title-desc">
                The <code className="highlighter-rouge">.btn</code> classNamees
          ...
          <Card>
            <CardBody>
              ...
              <p className="card-title-desc">
                ...
                <code className="highlighter-rouge">data-toggle="Buttons"</code>{" "}
          ...
          <Card>
            <CardBody>
              ...
              <p className="card-title-desc">
                ...
                complex components. Use utility classNamees as needed to space
        ...
        <Col lg="6">
          <Card>
            <CardBody>
              ...
              <p className="card-title-desc">
                Instead of applying Button sizing classNames to every Button in
                a group, just add{" "}
                <code className="highlighter-rouge">size=""</code> to each{" "}
                <code className="highlighter-rouge">&lt;ButtonGroup&gt;</code>,
