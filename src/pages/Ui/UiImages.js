...
const UiImages = props => {
  ...
  return (
    <React.Fragment>
      <MetaTags>
        <title>Images | - Responsive Bootstrap 5 Admin Dashboard</title>
      </MetaTags>
        ...
        <Col lg={6}>
          ...
          <Card>
            <CardBody>
              ...
              <div className="">
                <img className="rounded me-4" alt=" " width="200" src={img4} />{" "}
                <img
