...
const UiAlert = props => {
  ...
  return (
    <React.Fragment>
      <MetaTags>
        <title>Alerts | - Responsive Bootstrap 5 Admin Dashboard</title>
      </MetaTags>
          ...
          <Card>
            <CardBody>
              ...
              <p className="card-title-desc">
                ...
                className, which adds extra padding to the right of the alert
          ...
          <Card>
            <CardBody>
              ...
              <p className="card-title-desc">
                Alerts are available for any length of text, as well as an
                optional dismiss button. For proper styling, use one of the four{" "}
                <strong>required</strong> contextual classNamees (e.g.,{" "}
