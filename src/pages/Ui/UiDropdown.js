...
const UiDropdown = props => {
  ...
  return (
    <React.Fragment>
      <MetaTags>
        <title>Dropdowns | - Responsive Bootstrap 5 Admin Dashboard</title>
      </MetaTags>
          ...
          <Card>
            <CardBody>
              ...
              <p className="card-title-desc mb-3">
                ...
                <code className="highlighter-rouge">.dropup</code> to the parent
                element.
              </p>
              <div className="">
                <Dropdown
        ...
        <Col lg={6}>
          <Card>
            <CardBody>
              ...
              <p className="card-title-desc mb-3">
                Add{" "}
                <code className="highlighter-rouge">.dropdown-menu-right</code>{" "}
