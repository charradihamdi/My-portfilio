...
const UiProgressbar = props => {
  ...
  return (
    <React.Fragment>
      <MetaTags>
        <title>Progress Bars | - Responsive Bootstrap 5 Admin Dashboard</title>
      </MetaTags>
          ...
          <Card>
            <CardBody>
              ...
              <p className="card-title-desc">
                ...
                value on the{" "}
                <code className="highlighter-rouge"> .progress-bar</code>, so if
                you change that value the outer{" "}
          ...
          <Card>
            <CardBody>
              ...
              <p className="card-title-desc">
                ...
                <code className="highlighter-rouge"> striped animated </code> to
