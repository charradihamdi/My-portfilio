...
const DatatableTables = props => {
  ...
  return (
    <React.Fragment>
      <MetaTags>
        <title>Data Tables | - Responsive Bootstrap 5 Admin Dashboard</title>
      </MetaTags>
          ...
          <Card>
            <CardBody>
              ...
              <p className="card-title-desc">
                ...
                you need to do to use it with your own tables is to call the
                construction function: <code>&lt;MDBDataTable /&gt;</code>.
              </p>
