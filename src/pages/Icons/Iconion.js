...
const IconIon = props => {
  ...
  return (
    <React.Fragment>
      <MetaTags>
        <title>Ion Icons | - Responsive Bootstrap 5 Admin Dashboard</title>
      </MetaTags>
          ...
          <Card>
            <CardBody>
              ...
              <Row className="icon-demo-content">
                ...
                <Col xl={3} lg={4} sm={6}>
                  <i className="ion ion-md-checkmark-circle-outline"></i> ion
                ...
                <Col xl={3} lg={4} sm={6}>
                  <i className="ion ion-md-information-circle-outline"></i> ion
            ...
            <div className="card-body">
              ...
              <div className="row icon-demo-content">
                ...
                <Col xl={3} lg={4} sm={6}>
                  <i className="ion ion-ios-checkmark-circle-outline"></i> ion
                ...
                <Col xl={3} lg={4} sm={6}>
                  <i className="ion ion-ios-information-circle-outline"></i> ion
