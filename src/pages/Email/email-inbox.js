...
const EmailInbox = props => {
  ...
  return (
    <React.Fragment>
      <MetaTags>
        <title>Inbox | - Responsive Bootstrap 5 Admin Dashboard</title>
      </MetaTags>
                  ...
                  <div className="col-mail col-mail-2">
                    <Link to="#" className="subject">
                      ...
                      <span className="teaser">
                        ...
                        inspiration for the weekend. Here are some trending
                        tracks and playlists we think you should give a listen!
                      </span>
                    </Link>
