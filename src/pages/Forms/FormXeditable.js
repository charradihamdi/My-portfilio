...
const FormXeditable = props => {
  ...
  return (
    <React.Fragment>
      <MetaTags>
        <title>Form Xeditable | - Responsive Bootstrap 5 Admin Dashboard</title>
      </MetaTags>
          ...
          <Card>
            <CardBody>
              ...
              <p className="card-title-desc">
                ...
                jquery only) and includes both popup and inline modes. Please
                try out demo to see how it works.
              </p>
